...
*/
    public static void eulerEleven(int a){
        ...
        System.out.println(gridString1D[0]);
        String[] gridString2D = new String[20];
        for (int i = 19; i >= 0; i++){
            gridString2D = gridString1D[i].split(" ");
            for (int j = 19; j >=0; j++){
                grid[j][i] = gridString2D[i];
            }
